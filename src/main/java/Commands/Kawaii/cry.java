        ...
        if (msg.length() < 1) {
            ...
            event.getTextChannel().sendMessage(
                    new EmbedBuilder().setColor(Color.PINK)
                            .setDescription("**" + msg + "** is crying because of **" + event.getMessage().getAuthor().getName() + "!**  qwq")
                            .setImage("https://cdn.discordapp.com/attachments/404334704804888577/409696192495353856/image.gif").build()).queue();
    }
}
