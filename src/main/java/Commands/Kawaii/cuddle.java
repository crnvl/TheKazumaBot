...
public class cuddle implements Command {
    @Override
        ...
        if (msg.length() < 1) {
            ...
            event.getTextChannel().sendMessage(
                    new EmbedBuilder().setColor(Color.PINK)
                            .setDescription("**" + msg + "**, you have been cuddled by **" + event.getMessage().getAuthor().getName() + "!** :3")
                            .setImage("https://cdn.discordapp.com/attachments/404334704804888577/408344769824292876/image.gif").build()).queue();
        }
    }
